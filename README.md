...
In order to manipulate the faces, I used the <a href="https://github.com/serengil/deepface">deepface</a> framework. Besides, to predict and describe the context of the image I made use of <i>CA⫶TR: Image Captioning with Transformers</i> implemented in <a href="https://github.com/saahiluppal/catr">this</a> repository.

You can also find a short clip illustrating the appearance of the app <a href="https://drive.google.com/file/d/1Rm0Fdfdy_fqo2cbN3SbJxRhjkBQe_i_8/view?usp=sharing">here</a>.
